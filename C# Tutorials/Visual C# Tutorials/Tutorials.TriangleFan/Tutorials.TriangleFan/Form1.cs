...
namespace Tutorials.TriangleFan
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            Text = "TriangleFan" ; // Set the text that appears in the top of the Form window
        ...
        public void DrawTriangleFan()
        {
            ...
            DX3DGraphicsCard.DrawPrimitives( PrimitiveType.TriangleFan, 0, 2 ); // 2 Triangles to draw a Square
        }
        ...
        public void VertexContainer( object sender, EventArgs e )
        {
            ...
            vertexBuffer = new VertexBuffer( typeof(CustomVertex.PositionColored ),
                4, dev, 0, CustomVertex.PositionColored.Format, Pool.Default);
            ...
            CustomVertex.PositionColored[] VerticeArray = new CustomVertex.PositionColored[ 4 ];

            // Drawing Vertices in a Clockwise direction
            VerticeArray[0].Position = new Vector3( 0.3f, -0.3f, 0 ); // bottom right Vertice
            VerticeArray[0].Color = System.Drawing.Color.Orange.ToArgb();

            VerticeArray[1].Position = new Vector3( -0.3f, -0.3f, 0 ); // bottom left
            VerticeArray[1].Color = System.Drawing.Color.Red.ToArgb();

            VerticeArray[2].Position = new Vector3( -0.3f, 0.3f, 0 ); // top left
            VerticeArray[2].Color = System.Drawing.Color.Orange.ToArgb();

            VerticeArray[3].Position = new Vector3( 0.3f, 0.3f, 0 ); // top right
            VerticeArray[3].Color = System.Drawing.Color.Yellow.ToArgb();

            //VerticeArray[4].Position = new Vector3( 0.9f, -0.3f, 0 ); // bottom right, etc...
            //VerticeArray[4].Color = System.Drawing.Color.Yellow.ToArgb();
        ...
        {
            if ((int)(byte)e.KeyChar == (int)System.Windows.Forms.Keys.Escape ) // If Escape key is pressed...
