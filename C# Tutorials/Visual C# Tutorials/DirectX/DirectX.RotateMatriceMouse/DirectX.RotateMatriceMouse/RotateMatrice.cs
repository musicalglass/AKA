/// <Title>Rotate Matrice in Y using X mouse Movement</Title>
...
namespace Tutorials.DirectX.RotateMatriceMouse
{
    class MyForm : Form
    {
        ...
        public void InitializeGraphicsCard()
        {
            ...
            {   // OK first, we create an Instance of the Parameters class
                ...
                DirectXGraphicsCard.RenderState.CullMode = Cull.None;
        ...
        public void CreateVertexArray(object sender, EventArgs e)
        {
            ...
            VerticeArray[0].Position = new Vector3(-0.25f, 0.32f, 0.0f); // Top Left Vertice 
            VerticeArray[0].Color = System.Drawing.Color.Red.ToArgb();

            VerticeArray[1].Position = new Vector3(0.25f, 0.32f, 0.0f); // Top Right
            VerticeArray[1].Color = System.Drawing.Color.Yellow.ToArgb();

            VerticeArray[2].Position = new Vector3(0.25f, -0.32f, 0.0f); // Bottom Right
            VerticeArray[2].Color = System.Drawing.Color.Blue.ToArgb();

            VerticeArray[3].Position = new Vector3(-0.25f, -0.32f, 0.0f); // Bottom Left
        ...
        public void DrawTriangleFan()
        {
            ...
            // Draw this type of object from our Points using 2 triangles
        ...
        {
            // Rotate Matrice using Mouse's X coordinate
