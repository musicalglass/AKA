...
namespace Tutorials.ElipseOutline
{
    class MyForm : Form
    {
        ...
        {
            Rectangle Dot = new Rectangle(320, 200, 2, 2); // Dot (Position X, Position Y, Width, Height)
            SolidBrush WhiteBrush = new SolidBrush(Color.White); // Create a brush to paint our Dot
