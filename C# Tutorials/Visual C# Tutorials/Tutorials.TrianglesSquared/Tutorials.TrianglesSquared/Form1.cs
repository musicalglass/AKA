...
namespace Tutorials.TwoTriangleSquare
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            Text = "Triangles Squared" ; // Set the text that appears in the top of the Form window
        ...
        public void DrawTriangle()
        {
            ...
            DX3DGraphicsCard.DrawPrimitives( PrimitiveType.TriangleList, 0, 2 );
        }
        ...
        public void VertexContainer( object sender, EventArgs e )
        {
            ...
            vertexBuffer = new VertexBuffer( typeof( CustomVertex.PositionColored ),
                6, dev, 0, CustomVertex.PositionColored.Format, Pool.Default );
            ...
            CustomVertex.PositionColored[] VerticeArray = new CustomVertex.PositionColored[6];

            VerticeArray[0].Position = new Vector3( -0.6f, 0.6f, 0 ); // top right Vertice
            VerticeArray[0].Color = System.Drawing.Color.Orange.ToArgb();

            VerticeArray[1].Position = new Vector3( 0.6f, -0.6f, 0 ); // bottom right
            VerticeArray[1].Color = System.Drawing.Color.Orange.ToArgb();

            VerticeArray[2].Position = new Vector3( -0.6f, -0.6f, 0 ); // bottom left
            VerticeArray[2].Color = System.Drawing.Color.Red.ToArgb();

            // Second Triangle starts here
            VerticeArray[3].Position = new Vector3( -0.6f, 0.6f, 0 ); // top left Vertice
            VerticeArray[3].Color = System.Drawing.Color.Orange.ToArgb();
            
            VerticeArray[4].Position = new Vector3( 0.6f, 0.6f, 0 ); // top right
            VerticeArray[4].Color = System.Drawing.Color.Yellow.ToArgb();

            VerticeArray[5].Position = new Vector3( 0.6f, -0.6f, 0 ); // bottom right
            VerticeArray[5].Color = System.Drawing.Color.Orange.ToArgb();
