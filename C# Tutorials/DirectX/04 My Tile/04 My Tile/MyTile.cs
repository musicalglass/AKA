...
namespace Tutorial.Tiles
{
    public class MyTile : Form
    {
        ...
        public void OnCreateVertexBuffer(object sender, EventArgs e)
        {
            ...
            verts[0].Position = new Vector3(32, 0, 0.5f); // Top Right
            verts[0].Color = System.Drawing.Color.AntiqueWhite.ToArgb();

            verts[1].Position = new Vector3(32, -32, 0.5f ); // Bottom Right
            verts[1].Color = System.Drawing.Color.Black.ToArgb();

            verts[2].Position = new Vector3(0, -32, 0.5f ); // Bottom Left
