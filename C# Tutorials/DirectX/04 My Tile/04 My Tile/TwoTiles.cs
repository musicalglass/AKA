...
namespace Tutorial.Tiles
{
    public class MyTile : Form
    {
        ...
        float SpritePositionX = -0.64f;
        float SpritePositionY = 0.64f;
        ...
        public void OnCreateDevice(object sender, EventArgs e)
        {
            ...
            dev.RenderState.Lighting = false; // Tuirn the Lights On!
            vertexBuffer = new VertexBuffer(typeof(CustomVertex.PositionColored), 
                BufferSize, device, 0, CustomVertex.TransformedColored.Format, Pool.Default);
        ...
        private void Render()
        {
            ...
            QuadMatrix.Translate(SpritePositionX, SpritePositionY, 0f);
            device.SetTransform(TransformType.World, QuadMatrix);
            device.DrawPrimitives(PrimitiveType.TriangleFan, 0, 2);
        ...
        protected override void OnKeyPress(System.Windows.Forms.KeyPressEventArgs e)
        {
            ...
            if ((int)(byte)e.KeyChar == (int)System.Windows.Forms.Keys.Right)
                SpritePositionX = SpritePositionX + 0.9f;
            if ((int)(byte)e.KeyChar == (int)System.Windows.Forms.Keys.Left)
                SpritePositionX = SpritePositionX - 0.9f; 
        }
